...
#define DASH_DISTANCE_F		(15.0f)
#define DASH_DISTANCE_B		(10.0f)
#define DASH_DISTANCE_L		(10.0f)
#define DASH_DISTANCE_R		(10.0f)
#define DASH_SPEED			(25.0f)
#define MAX_DASH_DISTANCE_FOR_SKILL		(25.0f)
...
//	MOVE_F_L,		// Forward + Left
//	MOVE_F_R,		// Forward + Right
//	MOVE_B_L,		// Backward + Left
//	MOVE_B_R,		// Backward + Right
